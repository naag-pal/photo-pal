...
router.post('/upload', function(req, res, next){
	...
	var tmpFile, nfile, fname, albumname;
						...
						req.on('response', function(res){
							if(res.statusCode == 200){
								...
								fs.unlink(nfile, function(){
									console.log('Local File Deleted ! animals' + albumname);
								})
...
router.get('/getimages/:album', function(req, res, next){
	singleImageModel.find({album:req.params.album}, null, {sort:{votes:-1}}, function(err, result){
